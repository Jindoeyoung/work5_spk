...
@Repository
public class UserGridsDAO_v5 {

    private static final String USER_GRIS_KEY = "USER_GRIDS_V5:${USER_ID}";
...
//        this.stringRedisTemplate = stringRedisTemplate;
    ...
    public List<String> getAllKeyValues() {
        ...
        while (cursor.hasNext()) {
            String user = StringUtils.replace(new String(cursor.next()), "USER_GRIDS_V5:", "");
