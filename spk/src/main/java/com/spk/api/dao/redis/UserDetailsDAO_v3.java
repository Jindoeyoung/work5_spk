...
@Repository
public class UserDetailsDAO_v3 {

    private static final String USER_DETAILS_KEY = "USER_DETAILS_V4:${USER_ID}";
...
//        this.stringRedisTemplate = stringRedisTemplate;
    ...
    public void setUser(UserDetails userApi) throws JsonProcessingException {
        String key = StringSubstitutor.replace(
    ...
    public List<String> getAllUsers() {
        ...
        while (cursor.hasNext()) {
            String user = StringUtils.replace(new String(cursor.next()), "USER_DETAILS_V4:", "");
