...
//							logger.info(yn);
	...
	@Override
	public String getSysMenuUsrList3(@Param("SYS_MENU_USR") SysMenuUsr pSysMenuUsr) throws Exception {
	    //============================================================
	    //< api-key check
	    //============================================================
		if (!authcheck.getMetaAuthErrGenerator(pSysMenuUsr.getApikey()).equals("{}")) {
		...
		try {
			...
			List<SysMenuUsr> sysMenuUsr = sysMenuUsrMapper.getSysMenuUsrList3(pSysMenuUsr);
...
//							logger.info(yn);
	...
	@Override
	public String getSysMenuUsrList_GR(@Param("SYS_MENU_USR") SysMenuUsr pSysMenuUsr) throws Exception {
	    //============================================================
	    //< api-key check
	    //============================================================
		if (!authcheck.getMetaAuthErrGenerator(pSysMenuUsr.getApikey()).equals("{}")) {
		...
		try {
			...
			List<SysMenuUsr> sysMenuUsr = sysMenuUsrMapper.getSysMenuUsrList_GR(pSysMenuUsr);
