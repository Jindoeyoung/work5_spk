...
//	}
	...
	@CrossOrigin(origins = "*", allowedHeaders = "*")
	public String getKorColumnName(@RequestBody StHakJeokM _hakjeokm) throws Exception {
		...
		StHakJeokM hakjeokm = sthakjeokmmapper.getKorColumnName(_hakjeokm.getHakbeon());
